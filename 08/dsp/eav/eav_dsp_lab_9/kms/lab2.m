clear;
fs = 1024;
n1 = 1;		         % длина реализации первого сигнала
n2 = 5;                 % длина реализации второго сигнала 
