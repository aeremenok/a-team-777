    ...
    extends SortMethod
{
    ...
    /**
     * ¬ыполнить сотрировку массива методом Ўелла ѕри сортировке Ўелла сначала
     * сравниваютс€ и сортируютс€ между собой ключи, отсто€щие один от другого
     * на некотором рассто€нии d. ѕосле этого процедура повтор€етс€ дл€
     * некоторых меньших значений d, а завершаетс€ сортировка Ўелла
     * упор€дочиванием элементов при d = 1 (то есть, обычной сортировкой
     * вставками).
     */
    protected void sort()
