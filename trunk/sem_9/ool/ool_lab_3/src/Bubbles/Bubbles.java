...
public class Bubbles extends JFrame {
	...
	public static void main(String[] args) {
		...
		Dimension desctopSize = java.awt.Toolkit.getDefaultToolkit().getScreenSize();
		frame.setSize((int)(desctopSize.getWidth()/2),(int)(desctopSize.getHeight()/2));
	...
	public void paint (Graphics g)
	{
		...
		while(i<arrayOfRounds.length)
		{
			...
			if(round!=null)
				g.drawOval(round.getX()-round.getRadius(),
					round.getY()-round.getRadius(), 
					round.getRadius(), 
					round.getRadius());
			i++;
		}
	...
	public Bubbles()
	{
		this.addMouseMotionListener(new MouseAdapter()
		{
			public void mouseMoved(MouseEvent e)
			{
				...
				if(repaint)Bubbles.this.repaint();
			}
		});
